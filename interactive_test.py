...
# Helper fx to save traj file and metadata
...
def RMSF_pLDDT_cluster_and_RMSD_trajectories(
        mm_output, out_path,
...
# Debug
mm_trajectories = RMSF_pLDDT_cluster_and_RMSD_trajectories(mm_output = mm_output,
                                                           out_path = out_path)
